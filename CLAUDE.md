...
- NEVER edit a merged ADR under `docs/decisions/` — merged ADRs are append-only; supersede with a new ADR. A *proposed* ADR may be created and revised inside its own PR, up until Amine's merge fixes it.
