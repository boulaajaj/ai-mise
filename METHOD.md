...
Encode what must be true; let the model decide how to think. A capable
model finds this page obvious. The harness exists so that what must be
true stays true even when the model isn't.
