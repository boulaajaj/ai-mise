---
type: view
title: Direction — living executive summary
---
...
You give it a name. You tell it what you do. It quietly sets everything in
place for your AI assistant — knowledge, memory, safeguards, undo — and then
gets out of your way. Plain language on the surface, high standards
underneath, for any profession.
...
- The public description spoke compiler jargon to humans — fixed 2026-07-23.
- Session reports used insider words ("canon") — the voice rule applies to
  our own reports, not just the product's mouth.
- Standing risk: adapter vocabulary leaking into the user-facing surface;
  the glossary and reviewer now guard it.
