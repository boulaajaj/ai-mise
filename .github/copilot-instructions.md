...
- Design assertions in docs must carry a claim label, in the vocabulary and exact
  written form defined once in the opening paragraph of `docs/architecture.md`. Flag
  unlabeled factual claims about platform behavior or research findings.
...
- **Exemption — plain-language surfaces.** The surfaces named in §7 (README, skill
  outputs, proposal templates) and any page that says under its title that it is
